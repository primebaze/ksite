    ...
    <div id="book" className="border border-neutral-200 p-8 sm:p-10">
      ...
      {status === "sent" ? (
        ...
        <form onSubmit={onSubmit} className="mt-7 space-y-7">
          ...
          <div className="grid grid-cols-2 gap-5">
            <label className="block">
              <span className="text-[11px] uppercase tracking-[0.2em] text-neutral-500">Email</span>
              <input name="email" type="email" required autoComplete="email" className={fieldCls} />
            </label>
            <label className="block">
              <span className="text-[11px] uppercase tracking-[0.2em] text-neutral-500">Phone</span>
