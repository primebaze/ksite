...
// The four "app window" demos used on the homepage feature stack and the
// Features page. These are deliberately motion-free (just timers + CSS), so
// importing them never pulls in an animation runtime — keeping the Features
// page light. The scroll-driven layout that arranges them lives in
// FeatureBento.tsx (homepage only).
...
export const WINDOWS: Record<string, () => React.ReactNode> = {
  design: DesignWindow,
  shield: ShieldWindow,
