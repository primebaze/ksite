...
export const GROUP_DESIGNS: Record<string, string[]> = {
  ...
  "Contractors & home": ["forge", "mason", "marigold", "meridian", "drafthouse", "summit", "velocity", "atelier", "bloom", "juniper", "ledger", "apex", "pipeworks", "livewire", "greenscape", "ridgeline", "rollwell", "latchkey", "cornerstone", "heartwood", "sparkle", "culina", "lagoon", "mendwell", "render", "tessera", "parquet"],
